...
void Model::create(UIProperties& properties) {
    ...
    const aiScene*   scene = importer.ReadFile(
      objPath, aiProcess_Triangulate | aiProcess_FlipUVs
...
void Model::processMesh(aiMesh* mesh, const aiScene* scene) {
    ...
    if (aiMaterial->Get(AI_MATKEY_SHININESS, specularColour) != AI_SUCCESS
        || true) {
        mSpecularExponent = 100000.0f;
    }

    material.mDiffuseColour
      = glm::vec3{ diffuseColour.r, diffuseColour.g, diffuseColour.b };
    material.mSpecularColour
      = glm::vec3{ specularColour.r, specularColour.g, specularColour.b };
...
const Texture2D& Model::getTexture(size_t             index,
